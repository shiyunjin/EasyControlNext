...
import com.shiyunjin.easycontrolnext.app.databinding.ActivityDeviceDetailBinding;
import com.shiyunjin.easycontrolnext.app.databinding.ItemLoadingBinding;
import com.shiyunjin.easycontrolnext.app.databinding.ItemScanAddressListBinding;
...
public class DeviceDetailActivity extends Activity {
  ...
  private void drawUI() {
    ...
    activityDeviceDetailBinding.pairPort.setText(String.valueOf(device.pairPort));
    activityDeviceDetailBinding.pairKey.setText(device.pairKey);
  ...
  private void setListener() {
    ...
    activityDeviceDetailBinding.ok.setOnClickListener(v -> {
      ...
      device.pairPort = Integer.parseInt(String.valueOf(activityDeviceDetailBinding.pairPort.getText()));
      device.pairKey = String.valueOf(activityDeviceDetailBinding.pairKey.getText());
      // 自定义分辨率
