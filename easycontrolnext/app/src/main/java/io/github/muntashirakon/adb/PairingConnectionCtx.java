...
public final class PairingConnectionCtx implements Closeable {
    ...
    private io.github.muntashirakon.adb.PairingAuthCtx mPairingAuthCtx;
    ...
    public PairingConnectionCtx(@NonNull String host, int port, @NonNull byte[] pswd, @NonNull KeyPair keyPair,
        ...
        this.mPeerInfo = new PeerInfo(PeerInfo.ADB_RSA_PUB_KEY, io.github.muntashirakon.adb.AndroidPubkey.encodeWithName((RSAPublicKey)
                keyPair.getPublicKey(), Objects.requireNonNull(deviceName)));
        this.mSslContext = io.github.muntashirakon.adb.SslUtils.getSslContext(keyPair);
    }
    ...
    private void setupTlsConnection() throws IOException {
        ...
        io.github.muntashirakon.adb.PairingAuthCtx pairingAuthCtx = io.github.muntashirakon.adb.PairingAuthCtx.createAlice(passwordBytes);
    ...
    private byte[] exportKeyingMaterial(SSLSocket sslSocket, int length) throws SSLException {
        ...
        try {
            ...
            if (io.github.muntashirakon.adb.SslUtils.isCustomConscrypt()) {
