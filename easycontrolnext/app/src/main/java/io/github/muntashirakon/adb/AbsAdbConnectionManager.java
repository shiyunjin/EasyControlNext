...
public abstract class AbsAdbConnectionManager implements Closeable {
    ...
    @Nullable
    private io.github.muntashirakon.adb.AdbConnection mAdbConnection;
    ...
    /**
     * Set whether to throw {@link io.github.muntashirakon.adb.AdbAuthenticationFailedException} if the daemon rejects the first authentication
     * attempt.
     *
     * @param throwOnUnauthorised {@code true} to throw {@link io.github.muntashirakon.adb.AdbAuthenticationFailedException} or {@code false}
     *                            otherwise.
     */
    @CallSuper
    ...
    /**
     * Get whether to throw {@link io.github.muntashirakon.adb.AdbAuthenticationFailedException} if the daemon rejects the first authentication
     * attempt.
     *
     * @return {@code true} if the system is configured to throw {@link io.github.muntashirakon.adb.AdbAuthenticationFailedException} or
    ...
    /**
     * Get the {@link io.github.muntashirakon.adb.AdbConnection} backed by this object.
     *
     * @return Underlying {@link io.github.muntashirakon.adb.AdbConnection}, or {@code null} if the connection hasn't been made yet.
     */
    @CallSuper
    @Nullable
    public io.github.muntashirakon.adb.AdbConnection getAdbConnection() {
        synchronized (mLock) {
            return mAdbConnection;
        }
    }

    public void setAdbCTop(Adb _adb) {
        assert mAdbConnection != null;
        mAdbConnection.Ctop = _adb;
    }
     ...
     * @throws io.github.muntashirakon.adb.AdbAuthenticationFailedException If {@link #isThrowOnUnauthorised()} is set to {@code true}, and the ADB
    ...
    public boolean autoConnect(@NonNull Context context, long timeoutMillis)
        ...
        synchronized (mLock) {
            ...
            mHostAddress = host;
            mAdbConnection = new io.github.muntashirakon.adb.AdbConnection.Builder(host, port)
                    .setApi(mApi)
     ...
     */
    @WorkerThread
    public boolean connect(int port) throws IOException, InterruptedException, io.github.muntashirakon.adb.AdbPairingRequiredException {
        synchronized (mLock) {
            if (isConnected()) {
                return false;
            }
            mAdbConnection = new io.github.muntashirakon.adb.AdbConnection.Builder(mHostAddress, port)
                    .setApi(mApi)
                    .setKeyPair(getAdbKeyPair())
                    .setDeviceName(Objects.requireNonNull(getDeviceName()))
                    .build();
    ...
    /**
     * Disconnect the underlying {@link io.github.muntashirakon.adb.AdbConnection}.
     *
     ...
     * @return {@link io.github.muntashirakon.adb.AdbStream} object corresponding to the specified destination
    ...
    @WorkerThread
    @NonNull
    public io.github.muntashirakon.adb.AdbStream openStream(String destination) throws IOException, InterruptedException {
        synchronized (mLock) {
     ...
     * This routine will block until the connection completes.
     *
     * @param service The service to open. One of the services under {@link io.github.muntashirakon.adb.LocalServices.Services}.
    ...
    public boolean pair(@NonNull String host, int port, @NonNull String pairingCode) throws Exception {
        synchronized (mLock) {
            io.github.muntashirakon.adb.KeyPair keyPair = getAdbKeyPair();
            try (io.github.muntashirakon.adb.PairingConnectionCtx pairingClient = new PairingConnectionCtx(Objects.requireNonNull(host), port,
                    io.github.muntashirakon.adb.StringCompat.getBytes(Objects.requireNonNull(pairingCode), "UTF-8"), keyPair, getDeviceName())) {
    ...
    @NonNull
    private io.github.muntashirakon.adb.KeyPair getAdbKeyPair() {
        return new io.github.muntashirakon.adb.KeyPair(Objects.requireNonNull(getPrivateKey()), Objects.requireNonNull(getCertificate()));
    }
}
