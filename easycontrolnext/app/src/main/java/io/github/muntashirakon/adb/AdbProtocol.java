...
final class AdbProtocol {
     ...
     */
    public static final byte[] SYSTEM_IDENTITY_STRING_HOST = io.github.muntashirakon.adb.StringCompat.getBytes("host::\0", "UTF-8");
    ...
    public static byte[] generateOpen(int localId, @NonNull String destination) {
        ...
        bbuf.put(io.github.muntashirakon.adb.StringCompat.getBytes(destination, "UTF-8"));
        bbuf.put((byte) 0);
